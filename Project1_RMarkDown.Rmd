...
hist(train$SalePrice, data = train, main = "Historgram of Sale Price", xlab = "Sale Price in US$")
...
hist(train$SalePrice, data = train, main = "Historgram of natural log of Sale Price", xlab = "Natural log of Sale Price in US$")
...
#Making the log transformation to SalePrice
ytrain$SalePrice <- log(ytrain$SalePrice)
